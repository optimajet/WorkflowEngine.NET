...
namespace OptimaJet.Workflow.PostgreSQL
{
    public class WorkflowProcessAssignment : DbObject<WorkflowProcessAssignment>
    {
        static WorkflowProcessAssignment()
        {
            ...
            {
                new ColumnInfo {Name = nameof(Id), IsKey = true, Type = NpgsqlDbType.Uuid},
                new ColumnInfo {Name = nameof(AssignmentCode)},
                new ColumnInfo {Name = nameof(ProcessId), Type = NpgsqlDbType.Uuid},
                new ColumnInfo {Name = nameof(Name)},
                new ColumnInfo {Name = nameof(Description)},
                new ColumnInfo {Name = nameof(StatusState)},
                new ColumnInfo {Name = nameof(IsActive), Type = NpgsqlDbType.Boolean},
                new ColumnInfo {Name = nameof(IsDeleted), Type = NpgsqlDbType.Boolean},
                new ColumnInfo {Name = nameof(DateCreation), Type = NpgsqlDbType.Timestamp},
                new ColumnInfo {Name = nameof(DateStart), Type = NpgsqlDbType.Timestamp},
                new ColumnInfo {Name = nameof(DateFinish), Type = NpgsqlDbType.Timestamp},
                new ColumnInfo {Name = nameof(DeadlineToStart), Type = NpgsqlDbType.Timestamp},
                new ColumnInfo {Name = nameof(DeadlineToComplete), Type = NpgsqlDbType.Timestamp},
        ...
        public static async Task<int> GetAssignmentCountAsync(NpgsqlConnection connection, List<FilterParameter> parameters )
        {
        ...
        private static NpgsqlParameter[] GetSqlParametersWithText(List<FilterParameter> parameters, string selectText, out string updatedSelectText)
        {
