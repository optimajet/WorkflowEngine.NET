...
namespace OptimaJet.Workflow.MySQL
{
    public class WorkflowProcessTransitionHistory : DbObject<WorkflowProcessTransitionHistory>
    {
       ...
       public WorkflowProcessTransitionHistory()
       {
        ...
        public static async Task<WorkflowProcessTransitionHistory []> SelectByProcessIdAsync(MySqlConnection connection, Guid processId, Paging paging = null)
        {
        ...
        public static async Task<WorkflowProcessTransitionHistory []>SelectByIdentityIdAsync(MySqlConnection connection, string identityId, Paging paging = null)
        {
