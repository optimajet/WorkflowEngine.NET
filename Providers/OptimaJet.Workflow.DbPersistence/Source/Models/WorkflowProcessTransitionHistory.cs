...
namespace OptimaJet.Workflow.DbPersistence
{
    public class WorkflowProcessTransitionHistory : DbObject<WorkflowProcessTransitionHistory>
    {
        ...
        public static async Task<WorkflowProcessTransitionHistory []> SelectByProcessIdAsync(SqlConnection connection, Guid processId, Paging paging = null)
        {
        ...
        public static async Task<WorkflowProcessTransitionHistory []>SelectByIdentityIdAsync(SqlConnection connection, string identityId, Paging paging = null)
        {
