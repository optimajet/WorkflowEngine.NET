...
namespace Budget2.DAL
{
    ...
    partial void OnNameChanged();
		...
		{
			this.SendPropertyChanging();
			entity.DemandAdjustmentState = this;
		}
		
		private void detach_DemandAdjustmentTransitionHistories(DemandAdjustmentTransitionHistory entity)
		{
			this.SendPropertyChanging();
			entity.DemandAdjustmentState = null;
		}
    ...
    partial void OnSumWithoutNDSChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MultiAllocationName", AutoSync=AutoSync.Always, DbType="NVarChar(256)", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MultiAllocationCode", AutoSync=AutoSync.Always, DbType="NVarChar(256)", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StructDivision_Demand", Storage="_StructDivision", ThisKey="AuthorStructDivisionId", OtherKey="Id", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="StructDivision_Demand1", Storage="_StructDivision1", ThisKey="ExecutorStructId", OtherKey="Id", IsForeignKey=true)]
	...
	public partial class ContractMoney : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _PaidState;
    ...
    partial void OnSumChanging(decimal value);
    partial void OnSumChanged();
    partial void OnPaidStateChanging(System.Nullable<bool> value);
    ...
    partial void OnExternalIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PaidState", DbType="Bit")]
		public System.Nullable<bool> PaidState
		{
			get
			{
    ...
    partial void OnDescriptionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="BillDemandState_BillDemandTransitionHistory", Storage="_BillDemandState", ThisKey="InitialStateId", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnDescriptionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DemandStatusInternal_DemandTransitionHistory", Storage="_DemandStatusInternal", ThisKey="InitialStateId", OtherKey="Id", IsForeignKey=true)]
		public DemandStatusInternal DemandStatusInternal
		{
			get
			{
	...
	public partial class DemandAdjustmentTransitionHistory : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<DemandAdjustmentState> _DemandAdjustmentState;
    ...
    partial void OnDescriptionChanged();
		...
		{
			this._DemandAdjustmentState = default(EntityRef<DemandAdjustmentState>);
		...
		public byte InitialStateId
		{
			...
			set
			{
				if ((this._InitialStateId != value))
				{
					if (this._DemandAdjustmentState.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnInitialStateIdChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DemandAdjustmentState_DemandAdjustmentTransitionHistory", Storage="_DemandAdjustmentState", ThisKey="InitialStateId", OtherKey="Id", IsForeignKey=true)]
		public DemandAdjustmentState DemandAdjustmentState
		{
			get
			{
				return this._DemandAdjustmentState.Entity;
			}
			set
			{
				DemandAdjustmentState previousValue = this._DemandAdjustmentState.Entity;
				if (((previousValue != value) 
							|| (this._DemandAdjustmentState.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._DemandAdjustmentState.Entity = null;
						previousValue.DemandAdjustmentTransitionHistories.Remove(this);
					}
					this._DemandAdjustmentState.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("DemandAdjustmentState");
				}
			}
		}
	...
	public partial class Counteragent : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<long> _IdCft;
    ...
    partial void OnFilialIdChanging(System.Nullable<System.Guid> value);
    partial void OnFilialIdChanged();
    partial void OnIdCftChanging(System.Nullable<long> value);
    ...
    partial void OnChangeDateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IdCft", DbType="BigInt")]
		public System.Nullable<long> IdCft
		{
			get
			{
				return this._IdCft;
