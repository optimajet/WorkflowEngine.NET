<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inbox.aspx.cs" MasterPageFile="~/Site.Master" 
    Inherits="WF.Sample.Pages.Document.Inbox" Title="Vacation requests" %>
<%@ Import Namespace="WF.Sample.Models" %>

<%@ Register TagPrefix="uc" TagName="PagingControl" Src="~/Controls/Paging.ascx" %>
<%@ Register TagPrefix="uc" TagName="AvailableCommands" Src="~/Controls/InboxAvailableCommandsControl.ascx" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Repeater id="DocsTableRepeater" runat="server" ItemType="WF.Sample.Models.InboxDocumentModel">
          <HeaderTemplate>
             <table class="grid">
                <tbody>
          ...
          <ItemTemplate>
              <tr ondblclick="SetHref('<%#: GetEditUrl(Item) %>')">
                ...
                <td><%#: Item.AddingDate %></td>
                  <td>
                     <uc:AvailableCommands id="AvailableCommands" Model="<%# Item %>" runat="server" />
                  </td>
            </tr>
          </ItemTemplate>
