        ...
        private static IMapper GetMapper()
        {
            var config = new MapperConfiguration(cfg => {
                ...
                cfg.CreateMap<StructDivision, Business.Model.StructDivision>()
                   ...
                   .ForMember(d => d.ParentId, o => o.MapFrom(s => s.ParentId == null ? null : new Guid?(new Guid(s.ParentId))))
                ;
                ...
                cfg.CreateMap<DocumentTransitionHistory, Business.Model.DocumentTransitionHistory>()
                   .ForMember(d => d.Id, o => o.MapFrom(s => new Guid(s.Id)))
                   .ForMember(d => d.EmployeeId, o => o.MapFrom(s => s.EmployeeId == null ? null : new Guid?(new Guid(s.EmployeeId))))
                   .ForMember(d => d.DocumentId, o => o.MapFrom(s => new Guid(s.DocumentId)))
                ;

                cfg.CreateMap<Document, Business.Model.Document>()
                   .ForMember(d => d.Id, o => o.MapFrom(s => new Guid(s.Id)))
                   .ForMember(d => d.ManagerId, o => o.MapFrom(s => s.ManagerId == null ? null : new Guid?(new Guid(s.ManagerId))))
